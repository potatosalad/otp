...
get_string(Config) when is_list(Config) ->
    ensure_lib_loaded(Config, 1),
    {7, <<"hejsan", 0, _:3/binary>>} = string_to_bin("hejsan", 10, latin1),
    {7, <<"hejsan", 0, _>>} = string_to_bin("hejsan", 8, latin1),
    {7, <<"hejsan", 0>>} = string_to_bin("hejsan", 7, latin1),
    {-6, <<"hejsa", 0>>} = string_to_bin("hejsan", 6, latin1),
    {-5, <<"hejs", 0>>} = string_to_bin("hejsan", 5, latin1),
    {-1, <<0>>} = string_to_bin("hejsan", 1, latin1),
    {0, <<>>} = string_to_bin("hejsan", 0, latin1),
    {1, <<0>>} = string_to_bin("", 1, latin1),
    {0, <<>>} = string_to_bin("", 0, latin1),
    {6, <<"hallå", 0, _, _>>} = string_to_bin("hallå", 8, latin1),
    {6, <<"hallå", 0, _>>} = string_to_bin("hallå", 7, latin1),
    {6, <<"hallå", 0>>} = string_to_bin("hallå", 6, latin1),
    {-5, <<"hall", 0>>} = string_to_bin("hallå", 5, latin1),
    {-4, <<"hal", 0>>} = string_to_bin("hallå", 4, latin1),
    {0, <<0, _, _>>} = string_to_bin("Ω", 3, latin1),
    {0, <<0, _>>} = string_to_bin("Ω", 2, latin1),
    {0, <<0>>} = string_to_bin("Ω", 1, latin1),
    {0, <<>>} = string_to_bin("Ω", 0, latin1),
    {7, <<"hejsan", 0, _:3/binary>>} = string_to_bin("hejsan", 10, utf8),
    {7, <<"hejsan", 0, _>>} = string_to_bin("hejsan", 8, utf8),
    {7, <<"hejsan", 0>>} = string_to_bin("hejsan", 7, utf8),
    {-6, <<"hejsa", 0>>} = string_to_bin("hejsan", 6, utf8),
    {-5, <<"hejs", 0>>} = string_to_bin("hejsan", 5, utf8),
    {-1, <<0>>} = string_to_bin("hejsan", 1, utf8),
    {0, <<>>} = string_to_bin("hejsan", 0, utf8),
    {1, <<0>>} = string_to_bin("", 1, utf8),
    {0, <<>>} = string_to_bin("", 0, utf8),
    {7, <<"hallå"/utf8, 0, _>>} = string_to_bin("hallå", 8, utf8),
    {7, <<"hallå"/utf8, 0>>} = string_to_bin("hallå", 7, utf8),
    {-5, <<"hall", 0, _>>} = string_to_bin("hallå", 6, utf8),
    {-5, <<"hall", 0>>} = string_to_bin("hallå", 5, utf8),
    {-4, <<"hal", 0>>} = string_to_bin("hallå", 4, utf8),
    {3, <<"Ω"/utf8, 0>>} = string_to_bin("Ω", 3, utf8),
    {-1, <<0, _>>} = string_to_bin("Ω", 2, utf8),
    {-1, <<0>>} = string_to_bin("Ω", 1, utf8),
    {0, <<>>} = string_to_bin("Ω", 0, utf8),
    ok.

%% Test enif_get_string_length
get_string_length(Config) when is_list(Config) ->
    ensure_lib_loaded(Config, 1),
    0 = string_length("", latin1),
    6 = string_length("hejsan", latin1),
    5 = string_length("hallå", latin1),
    ?assertError(badarg, string_length("Ω", latin1)),
    ?assertError(badarg, string_length("hejsanΩ", latin1)),
    0 = string_length("", utf8),
    6 = string_length("hejsan", utf8),
    6 = string_length("hallå", utf8),
    2 = string_length("Ω", utf8),
    8 = string_length("hejsanΩ", utf8),
    ok.
...
get_atom(Config) when is_list(Config) ->
    ...
    {7, <<"hejsan", 0, _:3/binary>>} = atom_to_bin(hejsan, 10, latin1),
    {7, <<"hejsan", 0, _>>} = atom_to_bin(hejsan, 8, latin1),
    {7, <<"hejsan", 0>>} = atom_to_bin(hejsan, 7, latin1),
    {0, <<_:6/binary>>} = atom_to_bin(hejsan, 6, latin1),
    {0, <<>>} = atom_to_bin(hejsan, 0, latin1),
    {1, <<0>>} = atom_to_bin('', 1, latin1),
    {0, <<>>} = atom_to_bin('', 0, latin1),
    {6, <<"hallå", 0, _>>} = atom_to_bin('hallå', 7, latin1),
    {6, <<"hallå", 0>>} = atom_to_bin('hallå', 6, latin1),
    {0, <<_:5/binary>>} = atom_to_bin('hallå', 5, latin1),
    {0, <<_:3/binary>>} = atom_to_bin('Ω', 3, latin1),
    {0, <<_:2/binary>>} = atom_to_bin('Ω', 2, latin1),
    {0, <<_>>} = atom_to_bin('Ω', 1, latin1),
    {256, <<Longest1ByteLatin1AtomText:255/bytes, 0>>} = atom_to_bin(Longest1ByteLatin1Atom, 256, latin1),
    {256, <<Longest2ByteLatin1AtomText:255/bytes, 0>>} = atom_to_bin(Longest2ByteLatin1Atom, 256, latin1),
    {256, <<Longest2ByteLatin1AtomText:255/bytes, 0, _:255/bytes>>} = atom_to_bin(Longest2ByteLatin1Atom, 511, latin1),
    {256, <<Longest2ByteLatin1AtomText:255/bytes, 0>>} = atom_to_bin(Longest2ByteUtf8Atom, 256, latin1),
    {256, <<Longest2ByteLatin1AtomText:255/bytes, 0, _:255/bytes>>} = atom_to_bin(Longest2ByteUtf8Atom, 511, latin1),
    {0, <<_:256/bytes>>} = atom_to_bin(Longest3ByteUtf8Atom, 256, latin1),
    {0, <<_:766/bytes>>} = atom_to_bin(Longest3ByteUtf8Atom, 766, latin1),
    {0, <<_:256/bytes>>} = atom_to_bin(Longest4ByteUtf8Atom, 256, latin1),
    {0, <<_:1021/bytes>>} = atom_to_bin(Longest4ByteUtf8Atom, 1021, latin1),
    {7, <<"hejsan", 0, _:3/binary>>} = atom_to_bin(hejsan, 10, utf8),
    {7, <<"hejsan", 0, _>>} = atom_to_bin(hejsan, 8, utf8),
    {7, <<"hejsan", 0>>} = atom_to_bin(hejsan, 7, utf8),
    {0, <<_:6/binary>>} = atom_to_bin(hejsan, 6, utf8),
    {0, <<>>} = atom_to_bin(hejsan, 0, utf8),
    {1, <<0>>} = atom_to_bin('', 1, utf8),
    {0, <<>>} = atom_to_bin('', 0, utf8),
    {7, <<"hallå"/utf8, 0>>} = atom_to_bin('hallå', 7, utf8),
    {0, <<_:6/binary>>} = atom_to_bin('hallå', 6, utf8),
    {0, <<_:5/binary>>} = atom_to_bin('hallå', 5, utf8),
    {3, <<"Ω"/utf8, 0>>} = atom_to_bin('Ω', 3, utf8),
    {0, <<_:2/binary>>} = atom_to_bin('Ω', 2, utf8),
    {0, <<_>>} = atom_to_bin('Ω', 1, utf8),
    {256, <<Longest1ByteLatin1AtomText:255/bytes, 0>>} = atom_to_bin(Longest1ByteLatin1Atom, 256, utf8),
    {0, <<_:256/bytes>>} = atom_to_bin(Longest2ByteLatin1Atom, 256, utf8),
    {511, <<Longest2ByteUtf8AtomText:510/bytes, 0>>} = atom_to_bin(Longest2ByteLatin1Atom, 511, utf8),
    {0, <<_:256/bytes>>} = atom_to_bin(Longest2ByteUtf8Atom, 256, utf8),
    {511, <<Longest2ByteUtf8AtomText:510/bytes, 0>>} = atom_to_bin(Longest2ByteUtf8Atom, 511, utf8),
    {0, <<_:256/bytes>>} = atom_to_bin(Longest3ByteUtf8Atom, 256, utf8),
    {766, <<Longest3ByteUtf8AtomText:765/bytes, 0>>} = atom_to_bin(Longest3ByteUtf8Atom, 766, utf8),
    {0, <<_:256/bytes>>} = atom_to_bin(Longest4ByteUtf8Atom, 256, utf8),
    {1021, <<Longest4ByteUtf8AtomText:1020/bytes, 0>>} = atom_to_bin(Longest4ByteUtf8Atom, 1021, utf8),
    ok.
...
get_atom_length(Config) when is_list(Config) ->
    ...
    Longest4ByteUtf8AtomText = binary:copy(Char4ByteUtf8, 255),
    Longest4ByteUtf8Atom = erlang:binary_to_atom(Longest4ByteUtf8AtomText, utf8),
    0 = atom_length('', latin1),
    6 = atom_length('hejsan', latin1),
    5 = atom_length('hallå', latin1),
    ?assertError(badarg, atom_length('Ω', latin1)),
    ?assertError(badarg, atom_length('hejsanΩ', latin1)),
    255 = atom_length(Longest1ByteLatin1Atom, latin1),
    255 = atom_length(Longest2ByteLatin1Atom, latin1),
    255 = atom_length(Longest2ByteUtf8Atom, latin1),
    ?assertError(badarg, atom_length(Longest3ByteUtf8Atom, latin1)),
    ?assertError(badarg, atom_length(Longest4ByteUtf8Atom, latin1)),
    0 = atom_length('', utf8),
    6 = atom_length('hejsan', utf8),
    6 = atom_length('hallå', utf8),
    2 = atom_length('Ω', utf8),
    8 = atom_length('hejsanΩ', utf8),
    255 = atom_length(Longest1ByteLatin1Atom, utf8),
    510 = atom_length(Longest2ByteLatin1Atom, utf8),
    510 = atom_length(Longest2ByteUtf8Atom, utf8),
    765 = atom_length(Longest3ByteUtf8Atom, utf8),
    1020 = atom_length(Longest4ByteUtf8Atom, utf8),
    ok.
...
make_new_atoms(Config) when is_list(Config) ->
    ...
    Longest4ByteUtf8Atom = erlang:binary_to_atom(Longest4ByteUtf8AtomText, utf8),
    hejsan = make_new_atom(<<"hejsan">>, latin1),
    'hallå' = make_new_atom(<<"hallå">>, latin1),
    'Î©' = make_new_atom(<<"Ω"/utf8>>, latin1),
    '' = make_new_atom(<<>>, latin1),
    Longest1ByteLatin1Atom = make_new_atom(Longest1ByteLatin1AtomText, latin1),
    ?assertError(badarg, make_new_atom(TooLong1ByteLatin1AtomText, latin1)),
    Longest2ByteLatin1Atom = make_new_atom(Longest2ByteLatin1AtomText, latin1),
    ?assertError(badarg, make_new_atom(TooLong2ByteLatin1AtomText, latin1)),
    ?assertError(badarg, make_new_atom(Longest2ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_new_atom(TooLong2ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_new_atom(Longest3ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_new_atom(TooLong3ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_new_atom(Longest4ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_new_atom(TooLong4ByteUtf8AtomText, latin1)),
    hejsan = make_new_atom(<<"hejsan"/utf8>>, utf8),
    'hallå' = make_new_atom(<<"hallå"/utf8>>, utf8),
    'Ω' = make_new_atom(<<"Ω"/utf8>>, utf8),
    '' = make_new_atom(<<>>, utf8),
    Longest1ByteLatin1Atom = make_new_atom(Longest1ByteLatin1AtomText, utf8),
    Longest1ByteLatin1Atom = make_new_atom(TooLong1ByteLatin1AtomText, utf8),
    ?assertError(badarg, make_new_atom(Longest2ByteLatin1AtomText, utf8)),
    ?assertError(badarg, make_new_atom(TooLong2ByteLatin1AtomText, utf8)),
    Longest2ByteUtf8Atom = make_new_atom(Longest2ByteUtf8AtomText, utf8),
    Longest2ByteUtf8Atom = make_new_atom(TooLong2ByteUtf8AtomText, utf8),
    Longest3ByteUtf8Atom = make_new_atom(Longest3ByteUtf8AtomText, utf8),
    Longest3ByteUtf8Atom = make_new_atom(TooLong3ByteUtf8AtomText, utf8),
    Longest4ByteUtf8Atom = make_new_atom(Longest4ByteUtf8AtomText, utf8),
    ?assertError(badarg, make_new_atom(TooLong4ByteUtf8AtomText, utf8)),
    ok.
...
make_existing_atoms(Config) when is_list(Config) ->
    ...
    TooLong4ByteUtf8AtomText = binary:copy(Char4ByteUtf8, 256),
    Longest4ByteUtf8Atom = erlang:binary_to_atom(Longest4ByteUtf8AtomText, utf8),
    hejsan = make_existing_atom(<<"hejsan">>, latin1),
    'hallå' = make_existing_atom(<<"hallå">>, latin1),
    'Î©' = make_existing_atom(<<"Ω"/utf8>>, latin1),
    '' = make_existing_atom(<<>>, latin1),
    ?assertError(badarg, make_existing_atom(<<"hejsan1234">>, latin1)),
    ?assertError(badarg, make_existing_atom(<<"hallå1234">>, latin1)),
    ?assertError(badarg, make_existing_atom(<<"Ω1234"/utf8>>, latin1)),
    Longest1ByteLatin1Atom = make_existing_atom(Longest1ByteLatin1AtomText, latin1),
    ?assertError(badarg, make_existing_atom(Longest1ByteLatin1AtomTextNE, latin1)),
    ?assertError(badarg, make_existing_atom(TooLong1ByteLatin1AtomText, latin1)),
    Longest2ByteLatin1Atom = make_existing_atom(Longest2ByteLatin1AtomText, latin1),
    ?assertError(badarg, make_existing_atom(Longest2ByteLatin1AtomTextNE, latin1)),
    ?assertError(badarg, make_existing_atom(TooLong2ByteLatin1AtomText, latin1)),
    ?assertError(badarg, make_existing_atom(Longest2ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_existing_atom(Longest2ByteUtf8AtomTextNE, latin1)),
    ?assertError(badarg, make_existing_atom(TooLong2ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_existing_atom(Longest3ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_existing_atom(Longest3ByteUtf8AtomTextNE, latin1)),
    ?assertError(badarg, make_existing_atom(TooLong3ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_existing_atom(Longest4ByteUtf8AtomText, latin1)),
    ?assertError(badarg, make_existing_atom(Longest4ByteUtf8AtomTextNE, latin1)),
    ?assertError(badarg, make_existing_atom(TooLong4ByteUtf8AtomText, latin1)),
    hejsan = make_existing_atom(<<"hejsan"/utf8>>, utf8),
    'hallå' = make_existing_atom(<<"hallå"/utf8>>, utf8),
    'Ω' = make_existing_atom(<<"Ω"/utf8>>, utf8),
    '' = make_existing_atom(<<>>, utf8),
    ?assertError(badarg, make_existing_atom(<<"hejsan1234"/utf8>>, utf8)),
    ?assertError(badarg, make_existing_atom(<<"hallå1234"/utf8>>, utf8)),
    ?assertError(badarg, make_existing_atom(<<"Ω1234"/utf8>>, utf8)),
    Longest1ByteLatin1Atom = make_existing_atom(Longest1ByteLatin1AtomText, utf8),
    ?assertError(badarg, make_existing_atom(Longest1ByteLatin1AtomTextNE, utf8)),
    ?assertError(badarg, make_existing_atom(TooLong1ByteLatin1AtomText, utf8)),
    ?assertError(badarg, make_existing_atom(Longest2ByteLatin1AtomText, utf8)),
    ?assertError(badarg, make_existing_atom(Longest2ByteLatin1AtomTextNE, utf8)),
    ?assertError(badarg, make_existing_atom(TooLong2ByteLatin1AtomText, utf8)),
    Longest2ByteUtf8Atom = make_existing_atom(Longest2ByteUtf8AtomText, utf8),
    ?assertError(badarg, make_existing_atom(Longest2ByteUtf8AtomTextNE, utf8)),
    ?assertError(badarg, make_existing_atom(TooLong2ByteUtf8AtomText, utf8)),
    Longest3ByteUtf8Atom = make_existing_atom(Longest3ByteUtf8AtomText, utf8),
    ?assertError(badarg, make_existing_atom(Longest3ByteUtf8AtomTextNE, utf8)),
    ?assertError(badarg, make_existing_atom(TooLong3ByteUtf8AtomText, utf8)),
    Longest4ByteUtf8Atom = make_existing_atom(Longest4ByteUtf8AtomText, utf8),
    ?assertError(badarg, make_existing_atom(Longest4ByteUtf8AtomTextNE, utf8)),
    ?assertError(badarg, make_existing_atom(TooLong4ByteUtf8AtomText, utf8)),
    ok.
