...
ERL_NIF_API_FUNC_DECL(int,enif_get_atom_cache_index,(ErlNifEnv *env, ERL_NIF_TERM atom, unsigned *cache_index));
ERL_NIF_API_FUNC_DECL(int,enif_max_atom_cache_index,(void));
