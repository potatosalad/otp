...
-nifs([lib_version/0,
       ...
       term_type_nif/1,
       term_size_nif/1,
       get_atom_cache_index_nif/1,
       max_atom_cache_index_nif/0,
...
nif_atom_cache_index(Config) ->
    ensure_lib_loaded(Config),
    Max = max_atom_cache_index_nif(),
    true = is_integer(Max),
    true = Max > 0,
    CIX = get_atom_cache_index_nif(hello),
    true = is_integer(CIX),
    true = CIX >= 0,
    true = CIX =< Max,
    %% non-atom returns badarg
    {'EXIT', {badarg, _}} = (catch get_atom_cache_index_nif(42)),
    {'EXIT', {badarg, _}} = (catch get_atom_cache_index_nif("string")),
    ok.
...
get_atom_cache_index_nif(_) -> ?nif_stub.
max_atom_cache_index_nif() -> ?nif_stub.
